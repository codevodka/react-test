...
function App() {
  ...
  async function handleSelectPlace(selectedPlace) {
    ...
    // Update can be done at before changing state but then it can then keep the app in loading state which may make users think that the app is stuck
